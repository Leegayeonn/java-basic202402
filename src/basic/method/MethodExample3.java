...
6. 모든 메서드가 반환값이 있는 것은 아닙니다. 메서드 실행 후에
 반환할 값이 딱히 없다면 return 을 생략해도 됩니다.

7. 이 때는 반환유형을 메서드를 선언할 때 비워두지 마시고
 void 라는 키워드를 작성해 주셔야 합니다.

8. 모든 메서드는 return 을 만나면 강제로 메서드가 종료됩니다.
 따라서 조건 없이 return 문 아래에 코드를 작성할 수 없습니다.
...
//        System.out.println("야~~~~~~~"); (x)
    ...
    public static void main(String[] args) {
         ...
         */
//        int r4 = multi(10, 7); (x) -> 리턴이 없는데 변수에 담을수 없다
//        System.out.println(multi(4,4)); (x)  -> void 라는 값을 출력할수없다
        multi(10,7);
        multi(add(3,4),add(4,7));
//        add(multi(3,4),multi(4,7)); (x)
