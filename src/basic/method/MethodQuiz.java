...
//        else return true;
        return indexOf(targetName) != -1;  // true or false 로 결과값이 나옴
    ...
    public static void main(String[] args) {
        ...
        // 라면의 존재 여부 출력
        System.out.println("라면의 존재여부: "+ include("라면"));
        
        // 양념치킨의 존재 여부 출력
        System.out.println("양념치킨의 존재여부: "+ include("양념치킨"));
