...
public class VariableExample {
    ...
    public static void main(String[] args) {
        ...
        // 처음 만들때 한 번만 가능합니다. (데이터 타입이 앞에 붙었다는것은 새롭게 선언한다는 것을 의미)
        int score = 90;
        // int score = 95; 변수 중복안됨 (x)
        ...
        // 타입에 따라 !!
//        int count = "한번"; (x)
//        int count = 23.5;  (x) 실수라서 안됨
//        String str = 100; (x)

        // 변수는 자료형(데이터 타입)이 달라도 이름이 동일하다면 중복선언 불가능
        String name = "홍길동";
//        int name = 30; (x) 이름중복안됨!

        // 선언 및 초기화하지 않은 변수는 사용이 불가능
//        int result = myScore + num; (x) num을 선언한 적이 없음
        int result;
//        System.out.println("result = " + result); (x) 초기화가 필요(값을 담아야함) undefined 없음
