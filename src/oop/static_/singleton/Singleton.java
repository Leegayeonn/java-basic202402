...
public class Singleton {
    ...
    private static Singleton s = new Singleton();  // static 을 붙혀서 공유 객체를 만들어준다!
                                                    // 객체생성시 private 하게 바꾸어주면됨

    // 3. 외부에서 이 클래스의 객체를 요구할 시, 2번에서 미리 만들어놓은
    // 단 하나의 객체의 주소값을 공개된 메서드를 통해 리턴합니다.
    public static Singleton getInstance() {   // 관례적으로 메서드 이름은 getInstance
        return s;
    }
