...
//        String name = nick[3]; (x) 배열의 방법
        ...
        // 리스트 생성 후 객체 초기화 add()
        // 객체이기 때문에 int 가 아닌 Integer 로!
        List<Integer> score = new ArrayList<>();
        score.add(65);

        // 리스트 생성과 동시에 객체 초기화하기 Arrays.asList()
        ...
        // 컬렉션에서의 등장 횟수 구하기 Collections.frequency()
        System.out.println("100점 학생 수: " + Collections.frequency(score, 100));

        // 최대값, 최소값 구하기 Collections.max/min()
...
//        System.out.println(score);
        ...
        // -> 내림차 정렬 Collections.sort(리스트, Collections.reverseOrder())
