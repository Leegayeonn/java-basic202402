...
public class WrapperExample {
    ...
    public static void main(String[] args) {
        ...
        // boxing: 기본 데이터 타입을 객체 타입으로 변환하는 과정. -> deprecated 옛날버전
//        Integer v1 = new Integer(a);
//        Boolean v2 = new Boolean(b);

        // unboxing: 객체 타입으로 포장된 값을 기본 데이터타입으로 풀어내는 과정 -> deprecated
        // int i = v1.intValue();  -> deprecated (권장x)
...
//        int i = v1.intValue(); (x)
        ...
        Integer.parseInt("24.35"); //정수형태의 문자열을 줘야함.
