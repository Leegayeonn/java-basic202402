...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        kim.name = "김춘식";
        kim.career = 3;
        kim.lang = Language.JAVA;  // Language 열거형 클래스 생성하고 lang이 String이 아닌 Language클래스를 받았음
        ...
        System.out.println("hong의 주력언어: " + hong.lang);
        System.out.println("park의 주력언어: " + park.lang);

        System.out.println(kim.lang.getName());
        System.out.println(hong.lang.getName());
        System.out.println(park.lang.getName());
        ...
        System.out.println((park.lang.ordinal()+1) + "번째에 있어요."); // 인덱스값이라 1더해줌
